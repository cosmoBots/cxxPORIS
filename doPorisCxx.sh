...
if [ -d "$DEVBASE_USER_PATH" ]; then
  ...
  mv ${DEVBASE_USER_PATH}'/$S1_user.l/$S1_user.cpp' ${DEVBASE_USER_PATH}/${DEVNAME}.l/${DEVNAME}_user.cpp
  mv ${DEVBASE_USER_PATH}'/$S1_user.l/$S1_user.h'   ${DEVBASE_USER_PATH}/${DEVNAME}.l/${DEVNAME}_user.h  
